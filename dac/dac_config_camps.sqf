private ["_CampTyp", "_campBasic", "_campAmmo", "_campStatic", "_campWall", "_array", "_campObjInit", "_campUserObj", "_campAddUnit", "_campRandomObj", "_Unit_Pool_C"];
...
// =============================================================================
	case 0: { // OPFOR CAMP
		...
		_campObjInit   = [
			[],
			[format ["[0, { [(_this select 0), 'opfor', (_this select 1)] call BRM_fnc_assignCargo }, [_x, %1]] call CBA_fnc_globalExecute", _ammoBoxes]],
			["campObjsSTATIC pushBack [_x, '"+_loadout+"']"],
			[_loadout call _init],
			[],
			[],
			[]
...
// =============================================================================
	case 1: { // BLUFOR CAMP
		...
		_campObjInit   = [
			[],
			[format ["[0, { [(_this select 0), 'blufor', (_this select 1)] call BRM_fnc_assignCargo }, [_x, %1]] call CBA_fnc_globalExecute", _ammoBoxes]],
			["campObjsSTATIC pushBack [_x, '"+_loadout+"']"],
			[_loadout call _init],
			[],
			[],
...
// =============================================================================
	case 2: { // INDFOR CAMP
		...
		_campObjInit   = [
			[],
			[format ["[0, { [(_this select 0), 'indfor', (_this select 1)] call BRM_fnc_assignCargo }, [_x, %1]] call CBA_fnc_globalExecute", _ammoBoxes]],
			["campObjsSTATIC pushBack [_x, '"+_loadout+"']"],
			[_loadout call _init],
			[],
			[],
