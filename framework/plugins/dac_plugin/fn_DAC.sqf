...
switch (_command) do {
    case "create": {
        ...
        switch (true) do {
            ...
            case (_side == "side_a"): { _side = ["SIDE", side_a_side] call BRM_fnc_getDACStat };
            case (_side == "friendly"): { _side = ["SIDE", side_a_side] call BRM_fnc_getDACStat };    
            case (_side == "side_b"): { _side = ["SIDE", side_b_side] call BRM_fnc_getDACStat };
            case (_side == "enemy"): { _side = ["SIDE", side_b_side] call BRM_fnc_getDACStat };    
            case (_side == "side_c"): { _side = ["SIDE", side_c_side] call BRM_fnc_getDACStat };
        };
        
        _skill = ["SKILL", _skill] call BRM_fnc_getDACStat;
        ...
        switch (true) do {
            ...
            default {
                _faction = ["FACTION", _faction] call BRM_fnc_getDACStat;
            };
        };
        ...
        switch (true) do {
            case (_kind == "zone"): {
                ...
                [_name, _id, _status, _faction, _units select 0, _units select 1, _units select 2, _units select 3, _side, _skill, _area, _pos] spawn BRM_fnc_createDACZone;
            };
            case ((_kind == "camp") || (_kind == "camps")): {
                ...
                [_name, _id, _status, _faction, _respawns, _units, _reinforce, _side, _skill, _area, _pos] spawn BRM_fnc_createDACCamp;
            };
        };
    };
    case "generate": {
        obj = ["oz1",10,0,0,5,0,[],""] spawn DAC_Objects;
    };
};