...
%1 setTriggerStatements ['(time > 3)', _statement, ''];", _name, _id, _status, _arg1, _arg2, _arg3, _arg4, _side, _ax, _ay, _aa, _as, _pos];

mission_dac_zones pushBack _name; 

publicVariable "mission_dac_zones";

["ALL","CHAT", format ["%1 spawned a new zone.", player]] call BRM_fnc_doLog;