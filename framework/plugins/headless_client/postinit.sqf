...
if (mission_AI_controller) then { mission_AI_controller_name = player; publicVariable "mission_AI_controller_name" };
...
if (mission_AI_controller && !isServer) then {
    ...
    ["LOCAL","CHAT", format ["Headless Client ENABLED as %1.", mission_AI_controller_name]] call BRM_fnc_doLog;
};
