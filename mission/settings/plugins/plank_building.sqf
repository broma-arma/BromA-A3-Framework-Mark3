// Plank Building
	...
	// [[object, min distance], ...]
	// Example: _objectsSideA = [["MobileHQ", "10]];
	_objectsSideA = [];
	_objectsSideB = [];
	_objectsSideC = [];
	...
	_counts           = [1, 0, 10, 0, 15, 5, 0, 0]; // Other
	_countsOfficer    = [5, 3, 20, 5, 20, 10, 0, 5]; // Officers
	_countsFTL        = [3, 1, 20, 1, 15, 10, 0, 1]; // Team Leaders
	_countsSL         = [5, 2, 20, 3, 15, 10, 0, 2]; // Squad Leaders
	_countsSpecialist = [25, 15, 100, 25, 100, 50, 0, 25]; // Repair Specialists or Engineers

	// Build speed multiplier
	_buildSpeedMultiplier = 1;
#endif
